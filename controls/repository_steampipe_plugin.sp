benchmark "repository_steampipe_plugin_checks" {
  ...
  children = [
    ...
    control.repository_steampipe_plugin_delete_branch_on_merge_enabled,
    control.repository_steampipe_plugin_homepage_links_to_hub,
    control.repository_steampipe_plugin_language_is_go,
    control.repository_steampipe_plugin_license_is_apache,
    control.repository_steampipe_plugin_projects_disabled,
    control.repository_steampipe_plugin_squash_merge_allowed,
    control.repository_steampipe_plugin_standard_description_is_set,
    control.repository_steampipe_plugin_vulnerability_alerts_enabled,
    control.repository_steampipe_plugin_wiki_disabled,
  ]
